...
<DropdownMenuItem>Login</DropdownMenuItem>
          ...
          {/* NAVBAR DEKSTOP */}
          <div className="col-span-2 flex items-center gap-5" style={textStyle}>
            <div
                ...
                return (
                  <NavigationMenu className="border-b-2 md:border-b-0 ">
                    <NavigationMenuList>
                      <NavigationMenuItem
                        key={data.title}
                        className=" my-2 flex w-64 justify-center md:my-0 md:w-full"
                      >
                        {data.list ? (
                          <>
                            <NavigationMenuTrigger className="rounded-md bg-transparent px-5 py-2 text-sm hover:text-white hover:bg-transparent dark:bg-transparent">
                              {data.title}
                            </NavigationMenuTrigger>
                          ...
                          <>
                            <NavigationMenuLink
                              asChild
                              className={`${navigationMenuTriggerStyle()} text-md rounded-md bg-transparent px-5 py-2 hover:bg-transparent dark:bg-transparent hover:text-third`}
                            >
                              <div>
                                <a href={data.link}>
                                  <div>{data.title}</div>
